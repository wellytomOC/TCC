...
void ConfigureLpTIA(void){
  ...
  lp_cfg.LpDacCfg.DacData6Bit = 40;                    /* 6Bit DAC data */
  ...
  lp_cfg.LpAmpCfg.LpTiaSW = LPTIASW(12)|LPTIASW(13)|LPTIASW(2)|LPTIASW(10)|LPTIASW(5)|LPTIASW(9)|LPTIASW(7)|LPTIASW(6); /* Close these switches to make sure LP PA amplifier is closed loop */
  lp_cfg.LpAmpCfg.LpTiaRf = LPTIARF_20K;
